...
The current executable implements CP-P1 through CP-P5: input parsing and
tumor-only adjustment, support segmentation, observed-region aggregation,
fitting-region selection, and the full purity/ploidy score grid. Later
checkpoints add best-fit selection, copy number, QC, and the six gated writers.
